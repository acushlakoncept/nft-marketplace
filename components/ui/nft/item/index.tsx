            ...
            <div className="flex flex-col px-4 pt-4">
              ...
              <dd className="order-1 text-xl font-extrabold text-indigo-600">
                <div className="flex justify-center items-center">
                  100
                  <img className="h-6" src="/images/small-eth.webp" alt="eth icon" />
                </div>
              </dd>
            </div>
            { item.meta.attributes.map(attrib => (
              <div key={attrib.trait_type} className="flex flex-col px-4 pt-4">
                <dt className="order-2 text-sm font-medium text-gray-500">{attrib.trait_type}</dt>
                <dd className="order-1 text-xl font-extrabold text-indigo-600">{attrib.value}</dd>
              </div>
            ))}
          </dl>
        </div>
