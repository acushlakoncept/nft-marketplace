...
const NftCreate: NextPage = () => {
  ...
  const handAttributeChange = (e: ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    const attribIndex = nftMeta.attributes.findIndex(attrib => attrib.trait_type === name);

    nftMeta.attributes[attribIndex].value = value;
    setNftMeta({
      ...nftMeta,
